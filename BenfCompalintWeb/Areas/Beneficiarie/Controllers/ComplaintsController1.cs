...
namespace BenfCompalintWeb.Areas.Beneficiarie.Controllers
{
    ...
    //[ApiController]
    [Area("Beneficiarie")]
    public class ComplaintsController1 : Controller
    {
        ...
        public async Task<IActionResult> Index(int? page)
        {
            ...
            //ViewBag.Governorates = new SelectList(LocationDropdownsData.Governorates, "GoveId", "Name");
            //ViewBag.Directorates = new SelectList(LocationDropdownsData.Directorates, "DireId", "Name");
            //ViewBag.SubDirectorates = new SelectList(LocationDropdownsData.SubDirectorates, "SubDireId", "Name");
            //ViewBag.Villages = new SelectList(LocationDropdownsData.Villages, "VillId", "Name");
